...
const ModernMilestone = ({ user, userId }: Props) => {
  console.log(user);
  ...
  return (
    ...
    >
      <div className=" bg-pink-900 pl-4 pr-4 pb-4 pl-[24px]">
      ...
      <div className=" mt-[30px] ml-[16px]  pr-[24px]">
...
export default ModernMilestone;
